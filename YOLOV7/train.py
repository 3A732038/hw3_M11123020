...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'container_train.txt'
    val_annotation_path     = 'container_val.txt'
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            progress=fit_one_epoch(model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir, local_rank)
            if(progress):
                count=0
            else:
                count+=1
