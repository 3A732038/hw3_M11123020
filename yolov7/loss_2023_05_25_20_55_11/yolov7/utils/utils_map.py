...
def get_map(MINOVERLAP, draw_plot, score_threhold=0.5, path = './map_out',logs=''):
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        print(text)
    print(logs)
    with open(os.path.join(logs, "F1.txt"), 'a') as f:
        f.write(str(F1[score_threhold_idx]))
        f.write("\n") 
    with open(os.path.join(logs, "Recall.txt"), 'a') as f:
        f.write(str(rec[score_threhold_idx]*100))
        f.write("\n") 
    with open(os.path.join(logs, "Precision.txt"), 'a') as f:
        f.write(str(prec[score_threhold_idx]*100))
        f.write("\n")
    with open(os.path.join(logs, "mAP.txt"), 'a') as f:
        f.write(str(mAP*100))
        f.write("\n")                  
